# Full server.py code with auto-creation of .txt files and header lines
...
# Save final server.py
final_path = Path("/mnt/data/phishing_site/server.py")
final_path.write_text(final_server_code)
